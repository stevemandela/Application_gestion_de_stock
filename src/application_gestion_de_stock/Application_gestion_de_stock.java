...
package application_gestion_de_stock;

import java.net.Socket;
import java.sql.*;

public class Application_gestion_de_stock {
      ...
      public Application_gestion_de_stock(String url, String username, String password, String Host, int Port){
     ...
     public Connection connexionDatabase(){
         ...
         connection = DriverManager.getConnection(url, username, password);
                 ...
                 System.err.println(e.getMessage());// affiche ou se trouve le probleme exactement
                 } 
         return connection;
     } 
     ...
     //fonction pour afficher tous avec le parametre etat
